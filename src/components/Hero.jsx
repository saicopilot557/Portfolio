...
import heroVideo from '../assets/hero video/sai-hero.mp4';
import heroPoster from '../assets/hero video/sai-hero-poster.png';
...
const Hero = () => {
  ...
  const hasSocials = Boolean(socialLinks.github || socialLinks.linkedin || socialLinks.instagram);
